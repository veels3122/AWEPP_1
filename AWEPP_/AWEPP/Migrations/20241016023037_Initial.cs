...
namespace AWEPP.Migrations
{
        ...
        table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BalanceFee = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
    ...
    columns: table => new
    {
        ...
        NumberAccount = table.Column<string>(type: "nvarchar(max)", nullable: false), // Corregido de NumberAcount
        TotalBalance = table.Column<decimal>(type: "decimal(18,2)", nullable: false), // Cambiado a decimal
        PartialBalance = table.Column<decimal>(type: "decimal(18,2)", nullable: false), // Cambiado a decimal
        Debt = table.Column<decimal>(type: "decimal(18,2)", nullable: false), // Cambiado a decimal
        DatePayment = table.Column<DateTime>(type: "datetime", nullable: false), // Cambiado a DateTime
        Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
        CustomerId = table.Column<int>(type: "int", nullable: false),
        IsDeleted = table.Column<bool>(type: "bit", nullable: false)
    },
