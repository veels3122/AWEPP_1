...
namespace AWEPP.Migrations
{
    ...
    [Migration("20240918194020_Inictial")]
            ...
            modelBuilder.Entity("AWEPP.Model.Products", b =>
                {
                    ...
                    b.Property<int>("Type_accountsId")
                        .HasColumnType("int");

                    b.Property<int>("Type_productsId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Type_accountsId");

                    b.HasIndex("Type_productsId");
            ...
            modelBuilder.Entity("AWEPP.Model.Products", b =>
                {
                    ...
                    b.HasOne("AWEPP.Model.TypeAccounts", "Type_accounts")
                        .WithMany()
                        .HasForeignKey("Type_accountsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AWEPP.Model.TypeProducts", "Type_products")
                        .WithMany()
                        .HasForeignKey("Type_productsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("Type_accounts");

                    b.Navigation("Type_products");
                });
